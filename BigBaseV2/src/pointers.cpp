...
namespace big
{
	pointers::pointers()
	{
		...
		main_batch.add("RidCrashFunc", "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 20 49 8B F8 48 8B D9 45 84 C9 74 31 49 8B C8 E8 ? ? ? ? 84 C0 74 25 48 8D 4B 78 48 8B D7 E8 ? ? ? ? 84 C0 74 0D 80 3D ? ? ? ? ? 74 04 32 C0 EB 25", [this](memory::handle ptr)
		{
