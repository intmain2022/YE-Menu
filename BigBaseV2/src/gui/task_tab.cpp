	...
	void all_tab::task_tab()
	{
		if (ImGui::BeginTabItem("任务选项"))
		{
			if (ImGui::TreeNode("佩里克岛")) {
				...
				ImGui::SameLine();
				if(ImGui::Button("修改")) {
					*script_global(1973321).at(823).at(56).at(1).as<int*>() = player1;
				}
				ImGui::InputInt("玩家2分红", &player2);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1973321).at(823).at(56).at(2).as<int*>() = player2;
				}
				ImGui::InputInt("玩家3分红", &player3);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1973321).at(823).at(56).at(3).as<int*>() = player3;
				}
				ImGui::InputInt("玩家4分红", &player4);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1973321).at(823).at(56).at(4).as<int*>() = player4;
				}
				ImGui::Separator();
			...
			if (ImGui::TreeNode("赌场豪劫")) {
				if (ImGui::Button("跳过前置(气势汹汹方案)")) {
					g_fiber_pool->queue_job([]
						{
							STATS::STAT_SET_INT(MISC::GET_HASH_KEY("MP0_H3OPT_TARGET"), 3, 0);
							//
							STATS::STAT_SET_INT(MISC::GET_HASH_KEY("MP1_H3OPT_TARGET"), 3, 0);
							STATS::STAT_SET_INT(MISC::GET_HASH_KEY("MP0_H3OPT_APPROACH"), 3, 0);
							//
							STATS::STAT_SET_INT(MISC::GET_HASH_KEY("MP1_H3OPT_APPROACH"), 3, 0);
				...
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1966534).at(1497).at(736).at(92).at(1).as<int*>() = player1;
				}
				ImGui::InputInt("玩家2分红", &player2);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1966534).at(1497).at(736).at(92).at(2).as<int*>() = player2;
				}
				ImGui::InputInt("玩家3分红", &player3);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1966534).at(1497).at(736).at(92).at(3).as<int*>() = player3;
				}
				ImGui::InputInt("玩家4分红", &player4);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1966534).at(1497).at(736).at(92).at(4).as<int*>() = player4;
				}
				ImGui::Separator();
			...
			if (ImGui::TreeNode("末日抢劫")) {
				...
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1962546).at(812).at(50).at(1).as<int*>() = player1;
				}
				ImGui::InputInt("玩家2分红", &player2);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1962546).at(812).at(50).at(2).as<int*>() = player2;
				}
				ImGui::InputInt("玩家3分红", &player3);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1962546).at(812).at(50).at(3).as<int*>() = player3;
				}
				ImGui::InputInt("玩家4分红", &player4);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1962546).at(812).at(50).at(4).as<int*>() = player4;
				}
				ImGui::TreePop();
			}
			if (ImGui::TreeNode("公寓抢劫")) {
				...
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1933908).at(3008).at(1).as<int*>() = player1;
				}
				ImGui::InputInt("玩家2分红", &player2);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1933908).at(3008).at(2).as<int*>() = player2;
				}
				ImGui::InputInt("玩家3分红", &player3);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1933908).at(3008).at(3).as<int*>() = player3;
				}
				ImGui::InputInt("玩家4分红", &player4);
				ImGui::SameLine();
				if (ImGui::Button("修改")) {
					*script_global(1933908).at(3008).at(4).as<int*>() = player4;
				}
				ImGui::TreePop();
			}
